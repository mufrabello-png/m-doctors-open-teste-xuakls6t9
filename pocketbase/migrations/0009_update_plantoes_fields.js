  ...
  (app) => {
    ...
    const col = new Collection({
      ...
      fields: [
        ...
        { name: 'pessoaCPF', type: 'text' },
        { name: 'pessoaDataNascimentoFormatada', type: 'text' },
        { name: 'pessoaConselhoRegional', type: 'text' },
        { name: 'pessoaTelefoneFormatado', type: 'text' },
        { name: 'especialidadeNome', type: 'text' },
        { name: 'gradeNome', type: 'text' },
        ...
        { name: 'dataAtribuicaoFormatada', type: 'date' },
        { name: 'horarioInicioApuradoFormatado', type: 'date' },
        { name: 'horarioTerminoApuradoFormatado', type: 'date' },
        { name: 'horarioInicioFormatado', type: 'date' },
        { name: 'horarioTerminoFormatado', type: 'date' },
